package com.sws.java.ai.langchain4j.tools;

import com.sws.java.ai.langchain4j.entity.Appointment;
import com.sws.java.ai.langchain4j.service.AppointmentService;
...
public class AppointmentTools {
    ...
    @Tool(name = "查询是否有号源", value = "根据科室名称，日期，时间和医生查询是否有号源，并返回给用户,如果用户没有提供具体的医生姓名，请从\n" +
            "向量存储中找到一位医生。")
